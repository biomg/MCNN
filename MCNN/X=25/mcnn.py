...
def run_ideepe(parser):
    ...
    if train:
        ...
        predict = (predict1 + predict2 + predict3 + predict4 + predict5 + predict6 + predict7 + predict8 + predict9 + predict10 +predict11 + predict12 + predict13 + predict14 + predict15 + predict16 + predict17)/17.0
        # print predict
	    # pdb.set_trace()
